...
public class HummingbirdAgent : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers vectorActionInput)
    {
        ActionSegment<float> vectorAction = vectorActionInput.ContinuousActions;
    ...
    public override void Heuristic(in ActionBuffers actionsOutInput)
    {
        ActionSegment<float> actionsOut = actionsOutInput.ContinuousActions;
